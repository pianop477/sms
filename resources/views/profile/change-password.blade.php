                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" name="current_password" class="form-control @error('current_password') invalid-feedback @enderror" id="currentPassword" placeholder="" value="{{old('current_password')}}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" name="new_password" class="form-control @error('new_password') invalid-feedback @enderror" id="newPassword" placeholder="" required value="{{old('new_password')}}">
                            <div class="input-group-append">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" name="confirm_password" class="form-control @error('confirm_password') invalid-feedback @enderror" id="confirmPassword" placeholder="" required value="{{old('confirm_password')}}">
                            <div class="input-group-append">
