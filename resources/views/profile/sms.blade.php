            ...
            <div class="card-body-scroll">
                    ...
                    <div class="classes-grid">
                        ...
                        <div class="class-option">
                            <input type="checkbox" class="class-checkbox" name="classes[]" value="{{ $class->id }}"
                                id="class{{ $class->id }}" {{ in_array($class->id, old('classes', [])) ? 'checked' : ''
                            }}>
                ...
                <div>
                    ...
                    <div class="group-grid">
                        ...
                        <label class="group-option">
                            <input type="checkbox" name="send_with_transport" value="1" {{ old('send_with_transport')
                                ? 'checked' : '' }}>
                            <div class="group-icon">
                        ...
                        <label class="group-option">
                            <input type="checkbox" name="send_to_teachers" value="1" {{ old('send_to_teachers')
                                ? 'checked' : '' }}>
                            <div class="group-icon">
                        ...
                        <label class="group-option">
                            <input type="checkbox" name="send_to_other_staff" value="1" {{ old('send_to_other_staff')
                                ? 'checked' : '' }}>
                            <div class="group-icon">
                        ...
                        <label class="group-option">
                            <input type="checkbox" name="send_to_drivers" value="1" {{ old('send_to_drivers')
                                ? 'checked' : '' }}>
                            <div class="group-icon">
            ...
            <div class="card-body-scroll">
                ...
                <div class="message-container">
                    ...
                    <textarea name="message_content" id="message_content"
                        ...
                        maxlength="{{ $maxChars }}">{{ old('message_content') }}</textarea>
                    ...
                    <div class="char-counter">
                        ...
                        <div>
                            <span class="badge"
                                style="background: {{ $isBasicPackage ? '#e17055' : '#4e54c8' }}; color: white; padding: 4px 8px; border-radius: 20px; font-size: 0.7rem;">
                        ...
                        <div class="sms-card">
                            ...
                            <div class="sms-card-footer">
                                ...
                                <button type="button" class="view-details-btn" data-bs-toggle="modal"
                                    data-bs-target="#smsModal" data-full-text="{{ htmlspecialchars($sms['text']) }}"
                                    data-to="{{ $sms['to'] }}" data-from="{{ $sms['from'] }}"
            ...
            <div class="modal-body">
                ...
                <div>
                    ...
                    <div class="p-3 bg-light rounded border"
                        style="white-space: pre-wrap; word-wrap: break-word; max-height: 200px; overflow-y: auto; font-size: 0.9rem;"
