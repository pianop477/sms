                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            @if ($parents->image == Null)
                                ...
                                @endif
                            @else
                                <img src="{{asset('assets/img/profile/'. $parents->image)}}" alt="" class="profile-user img img-fluid rounded-circle" width="300px" height="300px">
                            @endif
                        </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="edit">
                                ...
                                <form action="{{route('Parents.update', ['parents' => Hashids::encode($parents->id)])}}" method="POST" novalidate="" class="needs-validation" onsubmit="preventDefault();" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-6">
