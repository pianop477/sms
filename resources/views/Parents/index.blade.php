        ...
        <div class="card-header-modern">
            <div class="header-content">
                ...
                <div class="action-group">
                    <!-- Import Button -->
                    <button type="button" class="btn-modern btn-import" data-bs-toggle="modal"
                            ...
                            <td>
                                <div class="parent-info">
                                    <div class="parent-avatar">
                                        ...
                                        strtoupper(substr($parent->last_name, 0, 1)) }}
                                    </div>
                                    <span class="parent-name">{{ ucwords(strtolower($parent->first_name . ' ' .
                                        $parent->last_name)) }}</span>
                                </div>
                            </td>
                            <td>
                                <div
                                    class="gender-badge {{ strtolower($parent->gender) == 'male' ? 'gender-male' : 'gender-female' }}">
                            ...
                            <td>
                                <div class="action-icons">
                                    <a href="{{ route('Parents.edit', ['parent' => Hashids::encode($parent->id)]) }}"
                                        class="action-icon view" title="View Profile">
                ...
                <div id="previewStep" class="d-none">
                    ...
                    <div id="errorsContainer" class="d-none">
                        <div class="alert alert-danger">
                            <h6 class="alert-heading"><i class="fas fa-exclamation-triangle me-2"></i>Validation Errors
                            </h6>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-section-modern">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" name="fname" class="form-control-modern"
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" name="lname" class="form-control-modern"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    <label class="form-label-modern">Street/Village <span
                                            class="required">*</span></label>
                                    <input type="text" name="street" class="form-control-modern"
                    ...
                    <div class="form-section-modern">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    <label class="form-label-modern">First Name <span class="required">*</span></label>
                                    <input type="text" name="student_first_name" class="form-control-modern"
                                        value="{{ old('student_first_name') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" name="student_middle_name" class="form-control-modern"
                                        value="{{ old('student_middle_name') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    <label class="form-label-modern">Last Name <span class="required">*</span></label>
                                    <input type="text" name="student_last_name" class="form-control-modern"
                                        value="{{ old('student_last_name') }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group-modern">
                                    <label class="form-label-modern">Date of Birth <span
                                            class="required">*</span></label>
        ...
        <div class="overlay-progress">
            <div class="progress">
                <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar"
                    id="overlayProgress" style="width: 0%">
