            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-2 text-end">
                        <a href="{{route('Classes.index')}}" class="btn btn-info btn-action float-right">
                ...
                <!-- Edit Form -->
                <form class="needs-validation" novalidate action="{{route('Classes.update', ['id' => Hashids::encode($class->id)])}}" method="POST">
                    @csrf
                    @method('PUT')

                    <div class="form-section">
                        <h5 class="mb-4"><i class="fas fa-book me-2 text-primary"></i> Class Information</h5>
