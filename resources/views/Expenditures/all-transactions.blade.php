                                        ...
                                        @if (empty($transactions))
                                            <tr>
                                                <td class="text-center text-danger py-4" colspan="9">
                                                    ...
                                                    No expense bills records were found for {{\Carbon\Carbon::now()->format('F')}}!
                                                </td>
                                            </tr>
                                        @else
            ...
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title" id="exportReportModalLabel">
                        <i class="fas fa-file-export me-2"></i> Generate Expense Bills Report
                    </h5>
                ...
                <div class="modal-body">
                    <form id="editTransactionForm" class="needs-validation" novalidate method="POST" enctype="multipart/form-data" data-no-preloader>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="editCategory" class="form-label">Accounts <span class="text-danger">*</span></label>
