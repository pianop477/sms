                ...
                <div class="row align-items-center">
                    <div class="col-md-10">
                        <h4 class="header-title">
                            ...
                            Report For: <span class="student-highlight"> {{$students->first_name. ' '. $students->last_name}}</span> -
                            <span class="report-highlight text-capitalize"> {{$reports->title}}</span>
                            <span class="year-highlight">{{$year}}</span>
                        </h4>
                    </div>
                    <div class="col-md-2">
                        <a href="{{route('students.combined.report', ['school' => $school, 'year' => $year, 'class' => $class, 'report' => $report])}}" class="btn btn-back btn-xs float-right">
                ...
                <div class="report-info">
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">Academic Report PDF</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="pdf-container">
                    <div class="pdf-controls">
                        ...
                        <div class="pdf-actions">
                            <a href="{{ $fileUrl }}" download="Student_Report_{{$students->first_name}}_{{$students->last_name}}_{{$year}}.pdf" class="pdf-btn pdf-btn-download">
