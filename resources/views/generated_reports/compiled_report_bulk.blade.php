    ...
    <div class="report-container">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @php
                            $subjGrade = '';
                            // Use $markingStyle from controller, not $reports->marking_style
                            if ($markingStyle == 1) {
                ...
                <tr class="summary-row">
                    ...
                    @foreach ($examHeaders as $exam)
                        @php
                            ...
                            $examGrade = '';
                            // Use $markingStyle from controller
                            if ($markingStyle == 1) {
        ...
        <table class="exam-key-table" cellpadding="4" cellspacing="0">
            <tbody>
                ...
                <tr><td class="text-uppercase">{{ $spec->abbr ?? 'N/A' }}</td><td class="text-capitalize">{{ $spec->full_name ?? 'N/A' }}</td></tr>
                @endforeach
                <tr><td colspan="2" class="text-center">Note: "X" indicates that the student did not take the exam.</td></tr>
            </tbody>
        </table>
        @endif
        ...
        <table class="report-table" cellpadding="5" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $subject['position'] }}</td>
                    <td>
                        @if($subject['grade'] == 'A') Excellent
                        @elseif($subject['grade'] == 'B') Good
                        @elseif($subject['grade'] == 'C') Pass
                        @elseif($subject['grade'] == 'D') Poor
                        @else Fail
                        @endif
                    </td>
                </tr>
        ...
        @if ($markingStyle == 3 && isset($division))
        <table class="division-section" cellpadding="6" cellspacing="0">
            <tbody>
                <tr>
                    <td width="50%">
