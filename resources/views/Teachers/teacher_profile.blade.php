            ...
            <div class="col-lg-3">
                <div class="card ">
                    <div class="profile-header text-center">
                        @php
                            ...
                            if (!empty($imageName) && file_exists($imagePath)) {
                                ...
                                $avatarImage = asset(
                                    'storage/profile/' .
                                        ($teachers->gender == 'male' ? 'avatar.jpg' : 'avatar-female.jpg'),
                                );
                            }
                        @endphp
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('Teachers.show.profile', ['teacher' => Hashids::encode($teachers->id)]) }}"
                        ...
                        <ul class="nav nav-pills flex-column flex-lg-row">
                            ...
                            <li class="nav-item flex-fill text-center">
                                <a class="nav-link" href="#qualification" data-bs-toggle="tab">
                                    <i class="fas fa-award mr-1"></i> Qualification
                                </a>
                            </li>
                            <li class="nav-item flex-fill text-center">
                                <a class="nav-link" href="#subjects" data-bs-toggle="tab">
                                    <i class="ti-book mr-1"></i> Teaching Subjects
                                </a>
                            </li>
                            <li class="nav-item flex-fill text-center">
                                <a class="nav-link" href="#others" data-bs-toggle="tab">
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="teacher">
                                <h5 class="mb-4"><i class="fas fa-info-circle mr-2"></i> Personal Particulars</h5>
                                <table class="info-table">
                                    <tr>
                                        <th>Role</th>
                                        <td class="text-capitalize">
                                            <span
                                                class="badge-status bg-primary text-white">{{ $teachers->role_name }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $teachers->alternative_phone ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="tab-pane fade" id="qualification">
                                <h5 class="mb-4"><i class="fas fa-award mr-2"></i> Qualification Information</h5>
                                <table class="info-table">
                                    <tr>
                                        <th>Qualification</th>
                                        <td>
                            ...
                            <div class="tab-pane fade" id="subjects">
                                <h5 class="mb-4"><i class="ti-book mr-2"></i> Teaching Subject Information</h5>
                                ...
                                @else
                                    <table class="info-table">
                                        ...
                                        <tr>
                                            <th>Subject Name</th>
                                            <td>{{ ucwords(strtolower($subject->course_name)) }}</td></td>
                                        </tr>
                                        @endforeach
                                    </table>
                                @endif
                            ...
                            <div class="tab-pane fade" id="others">
                                <h5 class="mb-4"><i class="fas fa-id-card mr-2"></i> Bank & other Information</h5>
                                <table class="info-table">
                                    <tr>
                                        <th>NIN</th>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ $teachers->bank_account_number ?? 'N/A' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Account Name</th>
                                        <td>
                                            {{ $teachers->bank_account_name ?? 'N/A' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Bank Name</th>
                                        <td>
                                            {{ $teachers->bank_name ?? 'N/A' }}
                                        </td>
                                    </tr>
                                </table>
                            </div>
