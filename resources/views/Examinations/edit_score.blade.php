                    ...
                    <div class="table-responsive">
                        <table class="table table-custom table-responsive-md">
                            ...
                            <tbody>
                                ...
                                if (is_numeric($score)) {
                                if ($marking_style == 1) {
                                if ($score >= 41 && $score <= 50) { $grade='A' ; $bgColor='#97e897' ; } elseif ($score>=
                                    31 && $score <= 40) { $grade='B' ; $bgColor='#4edcdc' ; } elseif ($score>= 21 &&
                                        $score <= 30) { $grade='C' ; $bgColor='#e9f0aa' ; } elseif ($score>= 11 &&
                                            $score <= 20) { $grade='D' ; $bgColor='#ef8f8f' ; } elseif ($score>= 0 &&
                                                $score <= 10) { $grade='E' ; $bgColor='#ebc4f3' ; } else {
                                                    $grade='Error' ; $bgColor='red' ; } } elseif ($marking_style==2) {
                                                    if ($score>= 81 && $score <= 100) { $grade='A' ; $bgColor='#97e897'
                                                        ; } elseif ($score>= 61 && $score <= 80) { $grade='B' ;
                                                            $bgColor='#4edcdc' ; } elseif ($score>= 41 && $score <= 60)
                                                                { $grade='C' ; $bgColor='#e9f0aa' ; } elseif ($score>=
                                                                21 && $score <= 40) { $grade='D' ; $bgColor='#ef8f8f' ;
                                                                    } elseif ($score>= 0 && $score <= 20) { $grade='E' ;
                                                                        $bgColor='#ebc4f3' ; } else { $grade='Error' ;
                                                                        $bgColor='red' ; } } } @endphp <tr>
...
<script>
    ...
    // UNIQUE KEY: includes exam_type_id and exam_date to separate different exams
    ...
    scoreInputs.forEach((input, index) => {
        if (input.value.trim() !== '') updateGrade(input, index);
        ...
        input.addEventListener('blur', function() {
            const studentIdMatch = this.name.match(/scores\[(\d+)\]/);
    ...
    function disableButtons() {
        ...
        if (!actionInput) {
            ...
            document.getElementById('resultsForm').appendChild(actionInput);
        }
