        ...
        <div class="glass-card">
            <div class="card-header-custom">
                <div class="row align-items-center">
                    <div class="col-md-10">
                        <h4 class="header-title text-white"><i class="fas fa-calendar-alt me-2"></i> Select Academic Year of Study</h4>
                    </div>
                    <div class="col-md-2">
            ...
            <div class="card-body">
                <div class="text-center mb-4">
                    <p class="warning-text"><i class="fas fa-exclamation-circle me-2"></i> Click on Specific Academic Year</p>
                </div>

                @if ($groupedData->isEmpty())
                    <div class="empty-state">
                        <i class="fas fa-exclamation-triangle"></i>
                        <h5>No Results Records Found!</h5>
                        <p class="mb-0"> It seems there are no academic results available at the moment.</p>
                    </div>
                @else
                    <div class="year-list">
                        @foreach ($groupedData as $year => $results)
                            <div class="year-card">
                                <span class="academic-badge">YEAR</span>
                                <div class="year-icon">
                                    <i class="fas fa-calendar-check"></i>
                                </div>
                                <h5>{{ $year }} Academic Year</h5>
                                <p class="text-muted">Click to view results for this academic year</p>
                                <a href="{{ route('results.byYear', ['course' => Hashids::encode($class_course->id), 'year' => $year]) }}" class="btn-view pulse-animation">
