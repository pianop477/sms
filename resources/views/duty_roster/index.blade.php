...
@section('content')
                                ...
                                <tbody>
                                    @foreach ($rosters as $key => $roster)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($firstRoster->start_date)->format('d-m-Y') ?? 'N/A' }}
                                            </td>
                                            <td>{{ \Carbon\Carbon::parse($firstRoster->end_date)->format('d-m-Y') ?? 'N/A' }}
                                            </td>
                                                        ...
                                                        <li>
                                                            <form method="POST"
                                                                ...
                                                                <button class="btn btn-success-custom" type="submit"
                                                                    title="Activate"
                                                                    onclick="return confirm('Activate this roster?');">
                                                        ...
                                                        <li>
                                                            <form
                                                                ...
                                                                <button class="btn btn-danger-custom" type="submit"
                                                                    title="Delete"
                                                                    onclick="return confirm('Delete this roster?');">
    ...
    <!-- Assign Roster Modal -->
    <div class="modal fade" id="assignRosterModal" tabindex="-1" role="dialog" aria-labelledby="assignRosterModalLabel"
        aria-hidden="true">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="date" name="start_date"
                                        ...
                                        class="form-control-custom" id="start_date" value="{{ old('start_date') }}"
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="date" name="end_date"
                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                        max="{{ \Carbon\Carbon::now()->addYear()->format('Y-m-d') }}"
                                        class="form-control-custom" id="end_date" value="{{ old('end_date') }}"
                                        required>
                                    <div class="invalid-feedback">
    ...
    @foreach ($rosters as $key => $roster)
        @php
            $firstRoster = $roster->first();
        @endphp
        <div class="modal fade" id="rosterModal{{ $key }}" tabindex="-1" role="dialog"
            aria-labelledby="rosterModalLabel{{ $key }}" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header-custom">
                        <h5 class="modal-title text-white">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <p><strong><i class="fas fa-calendar-start text-primary me-2"></i> Start Date:</strong>
                                    <span
                                        class="text-danger">{{ \Carbon\Carbon::parse($firstRoster->start_date)->format('d-m-Y') ?? 'N/A' }}</span>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p><strong><i class="fas fa-calendar-day text-primary me-2"></i> End Date:</strong>
                                    <span
                                        class="text-danger">{{ \Carbon\Carbon::parse($firstRoster->end_date)->format('d-m-Y') ?? 'N/A' }}</span>
                                </p>
                            </div>
                        </div>
            ...
            if (form && submitButton) {
                form.addEventListener("submit", function(event) {
                    ...
                    submitButton.innerHTML =
                        `<span class="spinner-border spinner-border-sm me-2" role="status"></span> Assigning...`;
                });
            }
