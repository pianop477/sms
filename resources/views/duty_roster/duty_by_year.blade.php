            ...
            <div class="card-body">
                ...
                @if ($rosters->isEmpty())
                    <div class="empty-state">
                        ...
                        <h5>No Rosters Records Found!</h5>
                        <p class="mb-0"> It seems there are no duty rosters available at the moment.</p>
                    </div>
                    <div class="year-grid">
                        <div class="year-card">
                            ...
                            <h5>{{ now()->format('Y') }} Academic Year</h5>
                            <a href="{{ route('tod.roster.index', ['year' => now()->format('Y')]) }}" class="btn-view pulse-animation">
                    ...
                    <div class="year-grid">
                        @foreach ($rosters as $year => $dates)
                            <div class="year-card">
                                ...
                                <a href="{{ route('tod.roster.index', ['year' => $year ?? now()->format('Y')]) }}" class="btn-view pulse-animation">
                                    <i class="fas fa-eye me-2"></i> View Roster
                                </a>
                            </div>
                        @endforeach
                        @if (!array_key_exists(now()->format('Y'), $rosters->toArray()))
                            <div class="year-card">
                                <span class="year-badge">YEAR</span>
                                <div class="year-icon">
                                    <i class="fas fa-calendar-star"></i>
