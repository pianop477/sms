                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            ...
                            <div class="input-group">
                                <input type="password" id="exampleInputPassword1" placeholder="Password" name="password" class="form-control">
                        ...
                        <div class="form-gp">
                            ...
                            <div class="input-group">
                                <input type="password" id="exampleInputPassword2" placeholder="Repeat Password" name="password_confirmation" class="form-control">
                                <div class="input-group-append">
