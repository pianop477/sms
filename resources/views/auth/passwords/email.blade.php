  ...
  <div class="login-card">
    ...
    <form id="loginForm" method="POST" action="{{ route('password.email') }}">
      ...
      <div class="form-group">
        ...
        <input type="text" id="login" name="email" class="form-control" placeholder="user@example.com" required />
      </div>
    ...
    <div class="divider">Do you have an Account</div>

    <a href="{{route('login')}}" id="" class="setup-bio">Sign In</a>
  </div>
