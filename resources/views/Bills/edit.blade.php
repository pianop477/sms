        ...
        <div class="glass-card">
            <div class="card-header-custom">
                <div class="row align-items-center">
                    <div class="col-md-10">
                        <h4 class="header-title text-white"><i class="fas fa-edit"></i> Edit Payment Information</h4>
                    </div>
                    <div class="col-md-2">
                        <a href="{{route('bills.transactions')}}" class="btn btn-back float-right">
            ...
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="{{route('bills.update', ['bill' => Hashids::encode($bill->id)])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-4">
                            <label for="validationCustom02" class="form-label">Control Number</label>
                            <input type="text" name="control" disabled class="form-control form-control-custom text-uppercase" id="validationCustom02" placeholder="" value="{{old('control', $bill->control_number)}}" required="">
                            @error('control')
                            <div class="invalid-feedback">
                                <span class="text-danger">{{$message}}</span>
                            </div>
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <input type="text" name="class" disabled class="form-control form-control-custom text-uppercase" id="validationCustom02" placeholder="" value="{{old('class', $bill->class_code)}}" required="">
                            @error('class')
                            <div class="invalid-feedback">
                                <span class="text-danger">{{$message}}</span>
                            </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-4">
                            <label for="validationCustom02" class="form-label">Issued Date</label>
                            <input type="date" name="date" class="form-control form-control-custom" id="validationCustom02" placeholder=""
                                value="{{ old('date', \Carbon\Carbon::parse($bill->approved_at)->format('Y-m-d')) }}" required="">
                            @error('date')
                            <div class="invalid-feedback">
                                <span class="text-danger">{{$message}}</span>
                            </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-4">
                            ...
                            <select name="payment" id="selectPayment" class="form-control-custom">
                                ...
                                <option value="bank" {{ old('payment', $bill->payment_mode) == 'bank' ? 'selected' : '' }}>Bank</option>
                                <option value="cash" {{ old('payment', $bill->payment_mode) == 'cash' ? 'selected' : '' }}>Cash</option>
                                <option value="mobile" {{ old('payment', $bill->payment_mode) == 'mobile' ? 'selected' : '' }}>Mobile</option>
                            </select>
                            @error('payment')
                            <div class="invalid-feedback">
                                <span class="text-danger">{{$message}}</span>
