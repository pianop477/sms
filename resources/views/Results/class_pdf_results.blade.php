        ...
        <div class="glass-card">
            <div class="card-header-custom">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-2">
                        <a href="{{route('results.monthsByExamType', ['school' => Hashids::encode($schools->id), 'year' => $year, 'class' => Hashids::encode($class_id), 'examType' => Hashids::encode($exam_id), 'month' => $month])}}" class="btn btn-back btn-xs float-right">
                            <i class="fas fa-arrow-circle-left me-1"></i> Back
                        </a>
                    </div>
                    <div class="col-md-2">
                        <a href="{{ url()->current() }}?export_excel=1" class="btn btn-excel btn-xs float-right">
                ...
                <div class="pdf-container">
                    <div class="pdf-controls">
                        ...
                        <div class="pdf-actions">
                            <a href="{{ $fileUrl }}" download="Exam_Results_{{\Carbon\Carbon::parse($date)->format('d-m-Y')}}.pdf" class="pdf-btn pdf-btn-download">
