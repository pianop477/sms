        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-2">
                        <a href="{{ route('results.index', ['student' => Hashids::encode($students->id)]) }}" class="float-right">
                ...
                <div class="list-group">
                    ...
                    @else
                        @foreach ($examTypes as $exam)
                            <a href="{{ route('result.byMonth', ['student' => Hashids::encode($students->id), 'year' => $year, 'exam_type' => Hashids::encode($exam->exam_id)]) }}">
