                ...
                <div class="row align-items-center">
                    <div class="col-md-10">
                        <h4 class="header-title">
                            ...
                            <span class="student-highlight">{{$studentId->first_name. ' '. $studentId->last_name}}</span> - Report |
                            <span class="exam-highlight">{{$results->first()->exam_type}}</span>
                            (<span class="date-highlight">{{$date}}</span>)
                        </h4>
                    </div>
                    <div class="col-md-2">
                        <a href="{{route('result.byMonth', ['student' => Hashids::encode($studentId->id), 'year' => $year, 'exam_type' => Hashids::encode($exam_id)])}}" class="btn btn-back btn-xs float-right">
                            <i class="fas fa-arrow-circle-left me-1"></i> Back
                        </a>
                    </div>
                </div>
                <i class="fas fa-file-pdf floating-icons"></i>
            </div>
            <div class="card-body">
                <!-- Report Information -->
                <div class="report-info">
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <span class="info-value text-capitalize">{{$studentId->first_name. ' '. $studentId->last_name}}</span>
                        </div>
                        <div class="info-item">
                ...
                <div class="pdf-container">
                    <div class="pdf-controls">
                        ...
                        <div class="pdf-actions">
                            <a href="{{ $fileUrl }}" download="Student_Report_{{$studentId->first_name}}_{{$studentId->last_name}}_{{$date}}.pdf" class="pdf-btn pdf-btn-download">
