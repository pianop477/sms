...
@section('content')
    ...
    <div class="py-4">
        ...
        <div class="row mb-4">
            <div class="col-md-10">
                <h4 class="text-primary fw-bold border-bottom pb-2">Admin Profile</h4>
            </div>
            <div class="col-md-2 text-end">
                <a href="{{route('register.manager')}}" class="btn btn-info btn-action float-right">
                ...
                <div class="card">
                    <div class="card-header p-0">
                        <ul class="nav nav-pills flex-column flex-lg-row">
                            ...
                            <li class="nav-item flex-fill text-center">
                                <a class="nav-link" href="#school" data-bs-toggle="tab">
                                    <i class="fas fa-university me-1"></i> School details
                                </a>
                            </li>
                            <li class="nav-item flex-fill text-center">
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            {{-- NIN and form IV index number tab --}}
                                ...
                                <h5 class="mb-4"><i class="me-2"></i> School information</h5>
                                <table class="info-table">
                                    <tr>
                                        <th>School Name</th>
                                        <td>{{strtoupper($user->school_name ?? 'N/A')}}</td>
                                    </tr>
                                    <tr>
                                        <th>Registration Number</th>
                                        <td>
                                            {{strtoupper($user->school_reg_no ?? 'N/A')}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Postal Address</th>
                                        <td>
                                            {{strtoupper($user->postal_address ?? 'N/A')}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Postal Name</th>
                                        <td>{{ucwords(strtolower($user->postal_name ?? 'N/A'))}}</td>
                                    </tr>
                                </table>
                            </div>
                            <!-- Edit Account Tab -->
                            <div class="tab-pane fade" id="edit">
                                <h5 class="mb-4"><i class="fas fa-user-pen me-2"></i> Edit Admin Information</h5>

                                <form action="{{route('manager.update.profile', ['id' => Hashids::encode($user->id)])}}" method="POST" enctype="multipart/form-data" novalidate class="needs-validation">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label">School <span class="text-danger text-sm">(Max 1MB)</span></label>
                                                <select name="school" id="schoolSelect" class="form-control-custom">
                                                    <option value="{{$user->school_id}}">{{ucwords(strtolower($user->school_name))}}</option>
                                                </select>
                                                @error('image')
                                                    <div class="text-danger text-sm mt-1">{{$message}}</div>
                                                @enderror
