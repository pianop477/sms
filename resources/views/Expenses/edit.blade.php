        ...
        <div class="glass-card">
            <div class="card-header-custom">
                <div class="row align-items-center">
                    <div class="col-md-10">
                        <h4 class="header-title text-white"><i class="fas fa-edit"></i> Edit Expense Category</h4>
                    </div>
                    <div class="col-md-2">
                        <a href="{{route('expenses.index')}}" class="btn btn-back btn-xs float-right">
            ...
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="{{route('expense.update', ['category' => Hashids::encode($category['id'])])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-row">
                        <div class="col-md-6 mb-4">
                            <label for="validationCustom01" class="form-label">Expense Type</label>
                            <input type="text" name="name" class="form-control form-control-custom" id="validationCustom01" placeholder="Expense type" value="{{$category['expense_type']}}" required="">
                            @error('name')
