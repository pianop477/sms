...
<div class="col-lg-12 mt-5 align-content-between">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-10">
                    <h4 class="header-title">Attendance Report For: <span class="text-uppercase text-primary">{{ $firstRecord->student_firstname }} {{ $firstRecord->student_middlename }} {{ $firstRecord->student_lastname }}</span></h4>
                </div>
                <div class="col-2">
                    <a href="{{route('attendance.byYear', 'student' => Hashids::encode($student->id))}}"><i class="fa-solid fa-circle-arrow-left text-secondary" style="font-size: 2rem"></i></a>
                </div>
            </div>
