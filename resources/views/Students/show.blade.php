                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            @if ($students->image == Null)
                                <img src="{{public_path('assets/img/students/student.jpg')}}" alt="" class="profile-user img img-fluid rounded-circle" style="width: 100px;">
                            @else
                                <img src="{{public_path('assets/img/students/'. $students->image)}}" alt="" class="profile-user img img-fluid rounded-circle" style="width: 100px;">
                            @endif
                        </div>
