...
<div class="card mt-5">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-2">
                <a href="{{route('create.selected.class', ['class' => Hashids::encode($students->grade_class_id)])}}" class="btn btn-info float-right"><i class="fas fa-arrow-circle-left"></i> Back</a>
            </div>
        </div>
