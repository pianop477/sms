            ...
            <div class="header-content">
                ...
                <div class="action-group">
                    ...
                    <div class="dropdown dropdown-modern">
                        <button class="btn-modern btn-export dropdown-toggle" type="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                ...
                <table class="table-modern" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <span
                                    class="gender-badge {{ strtolower($student->gender) == 'male' ? 'gender-male' : 'gender-female' }}">
            ...
            <div class="modal-body">
                ...
                <form class="needs-validation" novalidate
                    ...
                    <div id="graduationYearField" class="form-group-modern" style="display: none;">
                        ...
                        <input type="number" name="graduation_year" id="graduation_year" class="form-control-modern"
                            placeholder="e.g 2025" min="{{ date('Y') - 5 }}" max="{{ date('Y') }}">
                            ...
                            <div class="form-group-modern">
                                ...
                                <select name="parent" id="parentSelect" class="form-control-modern" required>
                                    ...
                                    <option value="{{ $parent->id }}">
                                        {{ ucwords($parent->first_name . ' ' . $parent->last_name) }} - {{
                                        $parent->phone }}
                                    </option>
                                    @endforeach
                                </select>
            ...
            document.querySelectorAll('.needs-validation').forEach(form => {
                form.addEventListener('submit', function(e) {
                    ...
                    if (!this.checkValidity()) {
                        ...
                        // Form ni valid, sasa zuia double submission
