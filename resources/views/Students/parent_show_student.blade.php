    ...
    <div class="row">
      <div class="col-auto">
        <div class="avatar position-relative">
            @if (!empty($data->image))
                <img src="{{ asset('storage/students/' . $data->image) ?? asset('storage/students/student.jpg') }}" alt="profile_image" class="profile-img border-radius-lg shadow-sm" style="width: 120px; object-fit:cover; border-radius: 50px;">
            @else
