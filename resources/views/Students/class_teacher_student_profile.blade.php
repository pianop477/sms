            ...
            <div class="col-lg-3">
                <div class="card">
                    <div class="profile-header text-center">
                        ...
                        <h5 class="profile-name mb-1 text-capitalize" style="color:rgb(206, 177, 8)">{{ucwords(strtolower($students->first_name. ' '. $students->middle_name. ' '. $students->last_name))}}</h4>
