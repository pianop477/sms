        ...
        <div class="glass-card header-section fade-in">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead mb-0 opacity-90 text-white"> Locked OTP Attempts Tracking</p>
                </div>
                <div class="col-md-4 text-md-end">
                    <div class="stats-badge">
                        <i class="fas fa-shield-alt me-2"></i>
                        {{ $lockedOtps->count() }} Failed Attempts
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <div class="glass-card text-center p-3 fade-in">
                    ...
                    <h4 class="text-primary mb-1">{{ $lockedOtps->count() }}</h4>
            ...
            <div class="col-md-4">
                <div class="glass-card text-center p-3 fade-in" style="animation-delay: 0.1s;">
                    ...
                    <h4 class="text-primary mb-1">{{ $lockedOtps->unique('ip_address')->count() }}</h4>
            ...
            <div class="card-body p-0">
                <div class="d-flex justify-content-between align-items-center p-4 border-bottom">
                    <h4 class="text-primary mb-0">
                        <i class="fas fa-list me-2"></i>Locked OTP Attempts
                    </h4>
                ...
                <div class="table-responsive p-3">
                    <table class="modern-table table-responsive-md" id="myTable">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class="empty-state">
                                            ...
                                            <p class="text-muted mb-4">No Locked OTP attempts detected. Your system is protected.</p>
                            ...
                            @else
                                @foreach ($lockedOtps as $row)
                                    <tr class="slide-in" style="animation-delay: {{ $loop->index * 0.05 }}s;">
                                        <td class="fw-bold text-primary">{{ $loop->iteration }}</td>
                                        <td>
                                            <span class="ip-address">
                                                <i class="fas fa-network-wired me-2"></i>{{ $row->ip_address }}
                                            </span>
                                        </td>
                                        <td>
                                            <span class="username">
                                                <i class="fas fa-user me-2"></i>{{ $row->attemps }}
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="timestamp">
                                                ...
                                                {{ \Carbon\Carbon::parse($row->locked_until)->format('M d, Y H:i:s') }}
                                            </span>
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <p class="text-muted mb-0">
                                ...
                                Showing {{ $lockedOtps->count() }} Locked OTP attempts
                            </p>
                        </div>
