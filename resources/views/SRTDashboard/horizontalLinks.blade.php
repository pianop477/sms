                ...
                <nav>
                    <ul id="nav_menu">
                        ...
                        @if (Auth::user()->usertype == 1)
                            <li>
                                <a href="{{ route('register.manager') }}"><i class="fa fa-users"></i><span>
                                        Administrators</span></a>
                            </li>
                            <li class="mega-menu">
                                <a href="{{ route('Schools.index') }}"><i class="fas fa-university"></i>
                                    <span>Schools</span></a>
                            </li>
                            <li>
                                <a href="{{ route('admin.reset.password') }}"><i class="ti-key"></i><span>Password
                                        Reset</span></a>
                            </li>
                            <li>
                                <a href="{{ route('admin.accounts') }}"><i class="fas fa-user-lock"></i><span>Admin
                                        Accounts</span></a>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="{{ route('failed.login.attempts') }}"><i
                                                class="fas fa-user-secret"></i> Failed Login</a></li>
                                    <li><a href="{{ route('locked.otps') }}"><i class="fas fa-user-lock"></i> Locked
                                            OTP</a></li>
                                </ul>
                            </li>
                        @endif
                        ...
                        @if (Auth::user()->usertype == 3 && Auth::user()->teacher->role_id == 3)
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="{{ route('Classes.index') }}"><i
                                                class="fas fa-chalkboard-teacher"></i> Classes</a></li>
                                    <li><a href="{{ route('courses.index') }}"><i class="fas fa-book-open"></i>
                                            Courses</a></li>
                                    <li><a href="{{ route('exams.index') }}"><i class="fas fa-clipboard-list"></i>
                                            Assessments</a></li>
                                    <li><a
                                            href="{{ route('results.general', ['school' => Hashids::encode(Auth::user()->school_id)]) }}"><i
                                                class="fas fa-chart-bar"></i> Results</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="{{ route('graduate.students.by.year') }}"><i
                                                class="fas fa-graduation-cap"></i> Alumni Reports</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="javascript:void(0)"><i class="fa fa-screwdriver-wrench"></i><span>Advanced
                                        Settings</span></a>
                                <ul class="submenu">
                                    <li><a href="{{ route('users.lists') }}"><i class="fas fa-key"></i> Password
                                            Reset</a></li>
                                    <li><a href="{{ route('Teachers.trashed') }}"><i class="fas fa-trash"></i> Recycle
                                            Bin</a></li>
                            ...
                            {{-- Announcements --}}
                            <li>
                                <a href="{{ route('sms.form') }}"><i
                                        class="ti-announcement"></i><span>Announcements</span></a>
                            </li>
                        @endif
                        ...
                        @if (Auth::user()->usertype == 2 || (Auth::user()->usertype == 3 && Auth::user()->teacher->role_id == 2))
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="{{ route('users.lists') }}"><i class="fas fa-key"></i> Password
                                            Reset</a></li>
                                    <li><a href="{{ route('Teachers.trashed') }}"><i class="fas fa-trash"></i>
                                            Recycle Bin</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="javascript:void(0)"><i
                                        class="fas fa-handshake-alt"></i><span>Services</span></a>
                                <ul class="submenu">
                                    <li><a href="{{ route('Transportation.index') }}"><i class="fa fa-bus-alt"></i>
                                            Transport</a></li>
                                    <li><a href="{{ route('sms.form') }}"><i class="ti-announcement"></i>
                                            Announcements</a></li>
                                </ul>
                            </li>
                        @endif
