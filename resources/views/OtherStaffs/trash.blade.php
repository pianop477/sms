            ...
            <div class="header-content">
                <div class="header-left">
                    ...
                    <div class="header-title">
                        ...
                        <p class="text-white">Manage and restore deleted non-teaching staff accounts</p>
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="user-info">
                                    ...
                                    <div>
                                        <strong class="text-capitalize">{{ $staffName }}</strong>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div
                                    class="gender-badge {{ strtolower($staff->gender) == 'male' ? 'gender-male' : 'gender-female' }}">
                            ...
                            <td class="text-center">
                                <div class="action-icons justify-content-center">
                                    ...
                                    <button type="button" class="action-icon danger delete-permanent-btn"
                                        ...
                                        data-url="{{ route('staffs.permanent-delete', ['type' => $staff->job_title, 'id' => Hashids::encode($staff->id)]) }}"
                                        data-name="{{ $staffName }}">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                    <!-- Restore Button -->
                                    <button type="button" class="action-icon success restore-btn" title="Restore Staff"
                                        data-url="{{ route('unblock.other.staffs', ['type' => $staff->job_title, 'id' => Hashids::encode($staff->id)]) }}"
                                        data-name="{{ $staffName }}">
