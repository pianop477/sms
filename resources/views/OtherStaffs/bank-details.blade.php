...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        <div class="page-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('OtherStaffs.profile', ['type' => $type, 'id' => Hashids::encode($staff->id)]) }}" class="btn-back">
        ...
        <div class="modern-card">
            <div class="card-body">
                <form class="needs-validation" novalidate
                    action="{{route('save.staff.bank', ['type' => $type, 'id' => Hashids::encode($staff->id)])}}" method="POST"
                                ...
                                <select name="bank_name" id="bank_name" class="form-control-modern" required>
                                    ...
                                    @foreach ($banks as $bank)
                                        <option value="{{ $bank['code'] }}"
                                            {{ old('bank_name', $staff->bank_name ?? '') == $bank['code'] ? 'selected' : '' }}>
                                            {{ $bank['name'] }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="text" name="account_number" maxlength="16" minlength="10"
                                    ...
                                    value="{{ old('account_number', $staff->bank_account_number ?? '') }}"
                    ...
                    <div class="row-custom">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="text" name="account_name" class="form-control-modern" id="account_name"
                                    ...
                                    value="{{ old('account_name', $staff->bank_account_name ?? '') }}" required>
                            </div>
                            <small class="text-muted mt-2 d-block">
                                <i class="fas fa-info-circle me-1"></i>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-with-icon">
                                <i class="fas fa-credit-card input-icon"></i>
                                <input type="text" class="form-control-modern" value="{{$staff->bank_account_number}}" id="confirm_account_number"
